...
<script type="text/javascript">
    ...
    function act(accion, auxid, cveplan, nomplan) {
        ...
        document.formularioPrincipal.nombrePrograma.value=nomplan;
                                                                                                ...
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">  
                                                                                                    ...
                                                                                                    <s:if test="escuela.AUXIDCCTPLAN.length()==0 && PROGVINCULADO==1">
                                                                                                        ...
                                                                                                        <tr <s:if test="ID_CCT_PLAN==escuela.AUXIDCCTPLAN">style=" color:purple; "</s:if>>
                                                                                                            ...
                                                                                                            <td align="center"><a href="Javascript:act('RegProgramaDescarga','<s:property value="ID_CCT_PLAN"/>','<s:property value="ID_CCT_PLAN"/>','<s:property value="NOM_CARRERA"/>')" ><i class="material-icons"><s:if test="escuela.AUXIDCCTPLAN==ID_CCT_PLAN">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                            </tr>
                                                                                    ...
                                                                                    <div id="dvData">  
                                                                                        ...
                                                                                        <table  style="text-align: justify;">
                                                                                            ...
                                                                                            <s:if test="ListaProgramasRegistro.size()>0"> 
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <s:iterator value="ListaProgramasRegistro" id="ListaProgramasRegistro" status="stat">                                                                                                                                      
                                                                                                            ...
                                                                                                            <tr style="color: #666666;" >
                                                                                                                ...
                                                                                                                <th><s:property value="NOM_CARRERA" /></th>
                                                                                                                <th><s:property value="CVE_PLAN_EST" /></th>
                                                                                                                <th><s:property value="ENFASIS" /></th>
                                                                                                                <th><s:property value="VERSION" /></th>
                                                                                                                <th><s:property value="NOMBRE_MATERIA" /></th>
                                                                                                                <th ><s:property value="NUMERO_PERIODO" /></th>
                                                                                                ...
                                                                                                <center>
                                                                                                    <input  align="top" type="image" id="btnExport"  src="assets/img/excel.png" style="width: 80px; margin-top: 20px; background: red;"  />
                                                                                                    <br><br>
                                                                                                    <s:url action="ejecutaServlet.action" id="myUrl" escapeAmp="false" namespace="/">
                                                                                                        <s:param name="reporte" value="'anexo1Dual.jasper'"/>
                                                                                                        <s:param name="nombreEsc" value="nombreEsc"/> 
                                    ...
                                    <footer class="footer">
                                        <div class="container-fluid">
                                            ...
                                            <div class="copyright float-center">
                                                ...
                                                <s:textfield name="nombrePrograma" id="nombrePrograma" cssStyle="display:none;" ></s:textfield>
