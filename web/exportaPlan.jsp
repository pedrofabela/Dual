                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">  
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_CCT_PLAN==escuela.AUXIDCCTPLAN">style=" color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td align="center"><a href="Javascript:act('RegProgramaDescarga','<s:property value="ID_CCT_PLAN"/>')" ><i class="material-icons"><s:if test="escuela.AUXIDCCTPLAN==ID_CCT_PLAN">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                    </tr>
