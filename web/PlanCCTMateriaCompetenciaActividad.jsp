...
<script type="text/javascript">
    ...
    function     guardaMateria(accion) {
     ...
     function     guardaActividad(accion) {

        var com = document.getElementById("ACTIVIDAD2").value;
        ...
        if (com.length > 0 ) {
            ...
            alert("Favor de capturar la Actividad");
    ...
    function     actualizaActividad(accion) {
       ...
       function muestra_oculta3(act, idact){
        
        
         document.formularioPrincipal.ACTIVIDAD2.value = act;
         document.formularioPrincipal.AUXACTIVIDAD.value = idact;
...
function actividad(accion, idcompetencia) {

        document.formularioPrincipal.AUXCOMPETENCIA.value = idcompetencia;
    ...
    function elimina(accion, idplancct) {
     ...
     function eliminaActividad(accion, idcom) {

        document.formularioPrincipal.AUXACTIVIDAD.value = idcom;
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>Nombre del Programa</th>
                                                                                                     <th>Clave Plan Estudios</th>
                                                                                                      <th>Versión</th>
                                                                                                    <th>Énfasis</th>
                                                                                                       <th align="center" style="text-align: center;" >Seleccionar Programa</th>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">  
                                                                                                    ...
                                                                                                    <s:if test="escuela.AUXIDCCTPLAN.length()==0 && PROGVINCULADO==1">
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_CCT_PLAN==escuela.AUXIDCCTPLAN">style=" color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td align="center"><a href="Javascript:act('AgregarMateriaPlanCompetenciaActividad','<s:property value="ID_CCT_PLAN"/>','<s:property value="CVE_PLAN"/>','<s:property value="NOM_CARRERA"/>')" ><i class="material-icons"><s:if test="escuela.AUXIDCCTPLAN==ID_CCT_PLAN">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                    </tr>
                                                                                                    
                                                                                                     </s:if>
                                                                                                    <s:else>
                                                                                                        <s:if test="ID_CCT_PLAN==escuela.AUXIDCCTPLAN && PROGVINCULADO==1">
                                                                                                    ...
                                                                                                    <s:hidden name =  "ListaProgramasEscuela[%{#stat.index}].PROGVINCULADO" id="PROGVINCULADO"></s:hidden>
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 80px;">
                                                                            <div class="card">
                                                                                <div class="card-header card-header-rose card-header-icon">
                                                                                    ...
                                                                                    <h4 class="card-title">Asignatura del Programa de Estudio</h4>
                                                                                </div>  
                                                                                                    ...
                                                                                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                                        <thead style="background: #302f2f; color:white;">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <th align="center" style="text-align: center;" >Seleccionar Asignatura</th>
                                                                                                        ...
                                                                                                        <s:iterator value="ListaPlanMateria" id="ListaPlanMateria" status="stat">                                                                                                                                      
                                                                                                            ...
                                                                                                            <s:if test="materia.AUXMATERIA.length()==0">
                                                                                                                ...
                                                                                                                <td align="center"><a href="Javascript:eliminaM('agregarPlanMateriaComActividad','<s:property value="ID_MATERIA"/>')" ><i class="material-icons" style="color:red;"><s:if test="materia.AUXMATERIA==ID_MATERIA">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                             </tr>
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 80px;">
                                                                            <div class="card">
                                                                                <div class="card-header card-header-info card-header-icon">
                                                                                    ...
                                                                                    <h4 class="card-title">Competencias de la Asignatura</h4>
                                                                                </div>  
                                                                                            ...
                                                                                            <div style="height: 200px; overflow-y: scroll; margin-top: 20px;">
                                                                                                ...
                                                                                                <div style="width: 100%; text-align: center; color: #b11a4f; "> <s:fielderror fieldName="ErrorBorrarMateria" id="ErrorBorrarMateria" ></s:fielderror></div>
                                                                                                    ...
                                                                                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                                        <thead style="background: #302f2f; color:white;">
                                                                                                            <tr>
                                                                                                                <th>Número de Competencia</th>
                                                                                                                <th>Nombre de la Competecia</th>

                                                                                                                
                                                                                                                 <th align="center" style="text-align: center;" >Seleccionar Competencia</th>
                                                                                                            </tr>
                                                                                                        </thead>
                                                                                                        ...
                                                                                                        <s:iterator value="ValidaMateriaCompetencia" id="ValidaMateriaCompetencia" status="stat">                                                                                                                                      
                                                                                                              ...
                                                                                                              <s:if test="competencia.AUXCOMPETENCIA.length()==0">
                                                                                                                ...
                                                                                                                <td align="center"><a href="Javascript:actividad('agregarActividad','<s:property value="ID_COMPETENCIA"/>')" ><i class="material-icons" style="color:#309cdd;"><s:if test="competencia.AUXCOMPETENCIA==ID_COMPETENCIA">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                             </tr>

                                                                                                            </s:if>
                                                                                                            <s:else>
                                                                                                                <s:if test="ID_COMPETENCIA==competencia.AUXCOMPETENCIA">
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 80px;">
                                                                            <div class="card">
                                                                                <div class="card-header card-header-success card-header-icon">
                                                                                    ...
                                                                                    <h4 class="card-title">Actividedes de la Competencia</h4>
                                                                                </div>  
                                                                                ...
                                                                                <div class="row">     
                                                                                        ...
                                                                                        <s:textfield name="actividad.ACTIVIDAD" id="ACTIVIDAD2" cssClass="form-control "  ></s:textfield>
                                                                                      ...
                                                                                      <div class="form-group col-md-12" id="guarda">
                                                                                          ...
                                                                                          <div class="card-footer justify-content-center"  >
                                                                                              <a href="Javascript:guardaActividad('guardaActividad')" class="btn btn-rose btn-link btn-lg" ><div style="background: #b11a4f; color: white; max-width: 200px; min-width: 180px; height: 40px; padding: 10px; border-radius: 3px;"> Registrar Actividad</div></a> 
                                                                                          </div>
                                                                                         ...
                                                                                         <div class="card-footer justify-content-center"   >
                                                                                              <a href="Javascript:actualizaActividad('actualizaActividad')" class="btn btn-rose btn-link btn-lg" ><div style="background: #b11a4f; color: white; max-width: 200px; min-width: 180px; height: 40px; padding: 10px; border-radius: 3px;"> Actualizar Actividad</div></a> 
                                                                                          </div>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                          ...
                                                                                          <s:if test="ListaActividadCct.size()>0"> 
                                                                                            ...
                                                                                            <div style="height: 200px; overflow-y: scroll; margin-top: 20px;">
                                                                                                ...
                                                                                                <div style="width: 100%; text-align: center; color: #b11a4f; "> <s:fielderror fieldName="ErrorBorrarMateria" id="ErrorBorrarMateria" ></s:fielderror></div>
                                                                                                    ...
                                                                                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                        <s:iterator value="ListaActividadCct" id="ListaActividadCct" status="stat">                                                                                                                                      
                                                                                                            <tr <s:if test="ID_ACTIVIDAD==actividad.AUXACTIVIDAD">style=" color:green; "</s:if> >
                                                                                                                <td ><s:property value="ID_ACTIVIDAD"/></td>
                                                                                                                <td><s:property value="ACTIVIDAD"/></td>

                                                                                                            <td align="center"><a  href="Javascript:muestra_oculta3('<s:property value="ACTIVIDAD"/>','<s:property value="ID_ACTIVIDAD"/>')" ><i class="material-icons" style="color:blue;">create</i></a></td>
                                                                                                            <td><a href="Javascript:eliminaActividad('eliminaActividad','<s:property value="ID_ACTIVIDAD"/>')" style="text-decoration: none; "><i class="material-icons" style="color:red;">delete_forever</i></a></td>
                                                                                                            
                                                                                                            
                                                                                                            </tr>

                                                                                                            <s:hidden  name = "ListaActividadCct[%{#stat.index}].ID_COMPETENCIA" id="ID_COMPETENCIA"></s:hidden>
                                                                                                            <s:hidden  name = "ListaActividadCct[%{#stat.index}].ACTIVIDAD" id="ACTIVIDAD"></s:hidden>
                                                                                                            <s:hidden  name = "ListaActividadCct[%{#stat.index}].ID_ACTIVIDAD" id="ID_ACTIVIDAD"></s:hidden>
                                                ...
                                                <div class="copyright float-center">
                                                    ...
                                                    <s:textfield name="escuela.AUXIDCCTPLAN" id="AUXIDCCTPLAN" cssStyle="display:none;" ></s:textfield>
                                                      <s:textfield name="competencia.AUXCOMPETENCIA" id="AUXCOMPETENCIA" cssStyle="display:none;"  ></s:textfield>
                                                        <s:textfield name="actividad.AUXACTIVIDAD" id="AUXACTIVIDAD" cssStyle="display:none;"  ></s:textfield>
                                                    <s:if test="!bnmateria">
                                                    ...
                                                    <s:hidden name="bnmateria" value="%{bnmateria}"></s:hidden>
                                                     <s:hidden name="bncompetencia" value="%{bncompetencia}"></s:hidden>
                                                      <s:hidden name="bnactividad" value="%{bnactividad}"></s:hidden>
