    ...
    function cerrar(accion) {
     ...
     function     guardaMateria(accion) {
      ...
      var cvemateria=document.getElementById("CVEMATERIANUEVA").value;
       ...
       if(cvemateria.length>0 && nommateria.length>0 && periodo.length>0){
        ...
        document.formularioPrincipal.submit();
           ...
           alert("Favor de capturar la Clave de la Materia, Nombre de la Materia y Periodo");
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">                                                                                                                                      
                                                                                                     ...
                                                                                                     <tr <s:if test="ID_CCT_PLAN==escuela.AUXIDCCTPLAN">style=" color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td align="center"><a href="Javascript:act('AgregarMateriaPlan','<s:property value="ID_CCT_PLAN"/>','<s:property value="CVE_PLAN"/>','<s:property value="NOM_CARRERA"/>')" ><i class="material-icons"><s:if test="escuela.AUXIDCCTPLAN==ID_CCT_PLAN">check_box</s:if><s:else>check_box_outline_blank</s:else></i></a></td>
                                                                                                    </tr>
                                                                  ...
                                                                  <div class="col-md-12" style="margin-top: 80px;">
                                                                        <div class="card">
                                                                            <div class="card-header card-header-rose card-header-icon">
                                                                                ...
                                                                                <h4 class="card-title">Asignaturas del Programa Educativo</h4>
                                                                            </div>  
                                                                            
                                                                            <div style="width: 100%; height: 50px; text-align: center; "><h3>Registro de Asignaturas</h3></div>
                                                                            ...
                                                                            <div class="row" style="margin-top: 30px;">
                                                                                ...
                                                                                <div class="form-group col-md-8">
                                                                                    ...
                                                                                    <div class="form-group col-md-3">
                                                                                        <label for="exampleEmail" class="bmd-label-floating">Clave de Asignatura</label>

                                                                                    <s:textfield name="materia.CVE_MATERIA" id="CVEMATERIANUEVA" cssClass="form-control "  ></s:textfield>
                                                                                 
                                                                                    </div>
                                                                                <div class="form-group col-md-6">
                                                                                        <label for="exampleEmail" class="bmd-label-floating">Nombre de la Asignatura</label>

                                                                                    <s:textfield name="materia.NOMBRE_MATERIA" id="NOMMATERIANUEVA" cssClass="form-control "  ></s:textfield>
                                                                                   
                                                                                    </div>
                                                                                    
                                                                                    <div class="form-group col-md-3">
                                                                                    
                                                                        <s:select  name="materia.NUMERO_PERIODO" id="PERIODO2" list="ListaPeriodo"  listKey="ID_PERIODO"  listValue="PERIODO"  headerKey="" headerValue="" cssClass="selectpicker " cssStyle="margin-top:20px;" data-style="select-with-transition" title="Periodo" data-size="7" tabindex="-98" ></s:select>
                                                                                ...
                                                                                <s:hidden  name = "ListaPeriodo[%{#stat.index}].PERIODO" id="PERIODO"></s:hidden>
                                                                                      ...
                                                                                      <div class="form-group col-md-12">
                                                                                          ...
                                                                                          <div class="card-footer justify-content-center" >
                                                                                              <a href="Javascript:guardaMateria('GuardaMateriaPlan')" class="btn btn-rose btn-link btn-lg" ><div style="background: #b11a4f; color: white; max-width: 200px; min-width: 180px; height: 40px; padding: 10px; border-radius: 3px;"> Registrar Asignatura</div></a> 
                                                                                          </div>
                                                                                    ...
                                                                                    <s:if test="ListaPlanMateria.size()>0"> 
                                                                                           ...
                                                                                           <div style="width: 100%; height: 50px; text-align: center; margin-top: 20px; "><h3>Listado de Asignaturas del Programa de Estudio</h3></div>
                                                                                        
                                                                                       <div style="height: 250px; overflow-y: scroll; margin-top: 50px;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            <thead style="background: #302f2f; color:white;">
                                                                                                <tr>
                                                                                                   <th>Clave de la Asinatura</th>
                                                                                                    <th>Nombre de la Asignatura</th>
                                                                                                   
                                                                                                    <th align="center"style="text-align: center;">Borrar Asignatura</th>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaPlanMateria" id="ListaPlanMateria" status="stat">                                                                                                                                      
                                                                                                    ...
                                                                                                    <tr <s:if test="CVE_MATERIA==materia.CVE_MATERIA">style=" color:purple; "</s:if> >
                                                                                                        <td ><s:property value="CVE_MATERIA"/></td>
                                                                                                        <td><s:property value="NOMBRE_MATERIA"/></td>
                                                                                                        
                                                                                                        <td align="center"><a href="Javascript:eliminaM('EliminaMateriaPlan','<s:property value="ID_MATERIA"/>')" ><i class="material-icons" style="color:red;">delete_forever</i></a></td>
                                                                                                    </tr>
