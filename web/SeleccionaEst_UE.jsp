...
<script type="text/javascript">
    ...
    function ActStatus(accion, historico, estatus) {
    ...
    function Rechazar(accion, historico, estatus) {
        var respuesta = confirm("¿Esta seguro que desea Rechazar al Alumno?. Esta acción eliminara el registro de la lista")
        if (respuesta == true) {
            document.formularioPrincipal.id_historico.value = historico;
            document.formularioPrincipal.status.value = estatus;
            document.formularioPrincipal.action = accion;
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                    <h3> Selección de Alumnos </h3>
                                                                </div>                                                                                                                                   
                                                                <div class="card-body">                                                          
                                                                    <div class="material-datatables">   
                                                                        <div class="row" style="margin-top: 20px;">
                                                                            <label for="exampleEmail" class="bmd-label-floating">Programa Educativo</label>
                                                                        <s:select  data-style="select-with-transition"   name="al.AUX_CVE_PRO_EDU" id="AUX_CVE_PRO_EDU" list="ListaPEUE"  listKey="ID_CCT_PLAN"  listValue="CARRERA" headerKey="" headerValue="Seleccione un programa educativo" onchange="Javascript:consulta('consultaAlumnosValidos')" cssClass="selectpicker col-lg-12"  />
                                                                        <s:iterator value="ListaPEUE" id="ListaPEUE" status="stat">  

                                                                            <s:hidden  name = "ListaPEUE[%{#stat.index}].ID_CCT_PLAN" id="ID_CCT_PLAN"></s:hidden>
                                                                            <s:hidden  name = "ListaPEUE[%{#stat.index}].CARRERA" id="CARRERA"></s:hidden>
                                                                            ...
                                                                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                <thead style="background: #302f2f; color:white;">
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>Estatus</th>
                                                                                        <th>Aceptar Alumno</th>
                                                                                        <th>Rechazar Alumno</th>
                                                                                    </tr>
                                                                                </thead>
                                                                    <s:if test="ListaValidados.size()>0"> 
                                                                                <tbody>
                                                                                    
                                                                                    
                                                                                    <s:iterator value="ListaValidados" id="ListaValidados" status="stat">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <s:if test="STATUS_PROCESO==3">
                                                                                                    <td class="text-warning text-center font-weight-bold"><div style="width: 100; display: block" ><i class="material-icons">sentiment_dissatisfied</i></div>validado</td>
                                                                                                </s:if>
                                                                                                <s:if test="STATUS_PROCESO==4">
                                                                                                    <td class="text-success text-center font-weight-bold"><div style="width: 100; display: block" ><i class=" material-icons">sentiment_very_satisfied</i></div>Aceptado</td>
                                                                                                </s:if>    
                                                                                                <td class="text-center"><s:if test="STATUS_PROCESO==3 ">
                                                                                                        <a href="Javascript:ActStatus('AprobarAlumno','<s:property value="ID_HISTORICO"/>', '4')" style="text-decoration: none; "><i class="material-icons">check_box_outline_blank</i>
                                                                                                        </a>
                                                                                                    </s:if>
                                                                                                    <s:else>
                                                                                                        <s:if test="STATUS_PROCESO==4">
                                                                                                            <a href="Javascript:ActStatus('AprobarAlumno','<s:property value="ID_HISTORICO"/>','3')" ><i class="material-icons">check_box</i>
                                                                                                            </a>
                                                                                                        </s:if>
                                                                                                    </s:else>
                                                                                                </td>
                                                                                                <td class="text-center"><s:if test="STATUS_PROCESO==3 ">
                                                                                                        <a href="Javascript:Rechazar('RechazarAlumno','<s:property value="ID_HISTORICO"/>', '2')" ><i class="material-icons text-danger">delete</i>
                                                                                                        </a>
                                                                                                    </s:if>
                                                                                                </td>    
                                                                                        ...
                                                                                        <s:hidden  name = "ListaValidados[%{#stat.index}].ID_HISTORICO" id="ID_HISTORICO"></s:hidden>
                                                                                        <s:hidden  name = "ListaValidados[%{#stat.index}].ID_ALUMNO" id="ID_ALUMNO"></s:hidden>
                                                                                        <s:hidden  name = "ListaValidados[%{#stat.index}].CURP" id="CURP"></s:hidden>
                                                                                        <s:hidden  name = "ListaValidados[%{#stat.index}].NOMBRE_COMPLETO" id="NOMBRE_COMPLETO"></s:hidden>
                                                                                        <s:hidden  name = "ListaValidados[%{#stat.index}].MATRICULA" id="MATRICULA"></s:hidden>
                                                                                        <s:hidden name =  "ListaValidados[%{#stat.index}].NOM_PRO_EDU" id="NOM_PRO_EDU"></s:hidden>
                                                                                        <s:hidden name =  "ListaValidados[%{#stat.index}].GRADO" id="GRADO"></s:hidden>
                                                                                        <s:hidden name =  "ListaValidados[%{#stat.index}].STATUS_PROCESO" id="STATUS_PROCESO"></s:hidden>
                                                                                        <s:hidden name =  "ListaValidados[%{#stat.index}].STATUS_ALUMNO" id="STATUS_ALUMNO"></s:hidden>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <td colspan="8"><div style="width: 100%; height: 35px; color: tomato; text-align: center;">¡No se encontraron Estudiantes!</div></td>
