...
<%@ taglib prefix="s" uri="/struts-tags"%>
   ...
   <script>
                                                                                                    ...
                                                                                                    function habilita(valor, Index) {
                                                                                                        
                                                                                                        
                                                                                                        alert("voy a habilitar  "+Index+"valor"+valor);
                                                                                                                document.getElementById("ListaProgramasRegistro[" + Index + "].EVIDENCIAS").disabled = false;
                                                                                                        }
                                                                                                        function deshabilita(valor, Index) {
                                                                                                            document.getElementById("ListaProgramasRegistro[" + Index + "].EVIDENCIAS").disabled = true;
                                                                                                            document.getElementById("ListaProgramasRegistro[" + Index + "].EVIDENCIAS").value = 0;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="card-body">  
                                                                    ...
                                                                    <div class="row" >
                                                                        ...
                                                                        <s:if test="ListaUE.size()>0">
                                                                               <div class="col-lg-12" style="margin-top: 30px;">
                                                                            <label for="exampleEmail" class="bmd-label-floating">Unidad Económica </label>
                                                                            <s:select  data-style="select-with-transition"   name="escuela.ID_IE_UE" id="escuela.ID_IE_UE" list="ListaUE"  listKey="ID_IE_UE"  listValue="RAZON_SOCIAL" headerKey="" headerValue="Seleccione Unidad Económica"  cssClass="selectpicker col-lg-12" onchange="Javascript:consulta('planConsultaEditaSelecciona'); telquita1();"  />
                                                                        <s:iterator value="ListaPE" id="ListaPE" status="stat">  
                                                                        ...
                                                                        <s:textfield  cssClass="form-control" name="programa.NOMBREPLAN_FORM" id="nom_planf" onkeyup="telquita2();"  ></s:textfield> 
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <s:if test="ACTIVIDAD.length()>0">
                                                                                ...
                                                                                <tr style="color: #666666;    <s:if test="ID_ACTIVIDAD==NO_PASA && NO_PASA!=null">background: #ffcccc ; </s:if>"  >
                                                                                                        ...
                                                                                                        <th align="center" style="align-content: center; text-align: center;"> <s:checkbox cssClass="form-check-sign"   name="ListaProgramasRegistro[%{#stat.index}].VALIDAR"  type="checkbox" id="ListaProgramasRegistro[%{#stat.index}].VALIDAR"  >  </s:checkbox>    </th>  
                                                                                                        <th align="center" style="align-content: center;"> <s:select data-style="select-with-transition" cssStyle="width:40px;" name="ListaProgramasRegistro[%{#stat.index}].ID_HORA"   id="HORAS_PLAN" list="ListaHora"  listKey="ID_HORA"  listValue="HORA+'hrs'" cssClass="selectpicker col-lg-12" headerValue="No.Horas" headerKey=""  >  </s:select>   </th>  
                                                                                                        <th align="center" style="align-content: center;"> <s:select data-style="select-with-transition" cssStyle="width:40px;" name="ListaProgramasRegistro[%{#stat.index}].ID_LUGAR"   id="LUGAR_PLAN" list="ListaLugar"  listKey="ID_LUGAR"  listValue="LUGAR" cssClass="selectpicker col-lg-12" headerValue="Lugar" headerKey="" >  </s:select>   </th>  
                                                                                                        <th align="center" style="align-content: center;"> <s:select data-style="select-with-transition" cssStyle="width:40px;" name="ListaProgramasRegistro[%{#stat.index}].ID_ESCALA"   id="ESCALA_PLAN" list="ListaEscala"  listKey="ID_ESCALA"  listValue="ESCALA+'%'" cssClass="selectpicker col-lg-12" headerValue="Escala" headerKey="" >  </s:select>   </th>  
                                                                                                ...
                                                                                                <s:hidden  name = "ListaProgramasRegistro[%{#stat.index}].NO_PASA" id="NO_PASA"></s:hidden>
                                                                                                 <s:hidden  name = "ListaProgramasRegistro[%{#stat.index}].INCLUIDA" id="INCLUIDA"></s:hidden>
                                                                            ...
                                                                            <a href="Javascript:consulta('actualizaPlanForm')"  class="btn btn-round btn-primary">Actualizar</a>
                                                                        </div>
