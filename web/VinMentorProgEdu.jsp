                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Vincular Mentor Académico con Programa de Educativo </h3>
                                                                    </div>
                                                                                ...
                                                                                <s:if test="objRenapo.AUXPERSONA.length()==0">
                                                                                    ...
                                                                                    <div style="height: 400px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="3"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Mentores Académcos!</div></td>
                                                                                            </tr>
                                                                                ...
                                                                                <s:else>
                                                                                 ...
                                                                                 <div style="height: 200px; overflow-y: scroll;">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">                                                                                                                                      
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="PROGVINCULADO==1"><a href="Javascript:actResProg('actualizaMentorResProgInst','<s:property value="ID_RES_PROGEDU"/>','0')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="PROGVINCULADO==null"><a href="Javascript:regResProg('guardaMentorResProgInst','<s:property value="ID_PLAN"/>')" ><i class="material-icons">check_box_outline_blank</i></a></s:if><s:if test="PROGVINCULADO==0"><a href="Javascript:actResProg('actualizaMentorResProgInst','<s:property value="ID_RES_PROGEDU"/>','1')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                    </tr>
                                                                                     ...
                                                                                     <s:else>
                                                                                         ...
                                                                                         <s:if test="objRenapo.AUXPERSONA.length()>0">
                                                                                         <div style="width: 100%; color: red; margin: auto; text-align: center;">¡No hay programas vinculados al Responsable de Programa Educativo!</div>
                                                                                         </s:if>
