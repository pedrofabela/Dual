...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
           ...
           <s:if test="programa.ID_NIVEL_CONSULTA==1">
            ['Periodo', 'Media Superior',{role: 'annotation'}],
          
     
             <s:iterator value="ListaHistDual" id="ListaHistDual" status="stat">
                   ['<s:property value="PERIODO" />',  <s:property value="MSUPERIOR" />, <s:property value="MSUPERIOR" /> ],
      </s:iterator>      
      </s:if>
           <s:if test="programa.ID_NIVEL_CONSULTA==2">
            ['Periodo', 'Superior',{role: 'annotation'}],
          
     
             <s:iterator value="ListaHistDual" id="ListaHistDual" status="stat">
                   ['<s:property value="PERIODO" />',  <s:property value="SUPERIOR" />, <s:property value="SUPERIOR" /> ],
      </s:iterator>      
      </s:if>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <a href="#popup4" style="text-decoration: none; color: white;" >    <div style="width: 100%; height: 30px;  background: rgba(0, 0, 0, 0.05); padding: 3px; margin-top: 10px; border-top: 0.5px solid #666; font-size: 12px; text-align: left;">    
                                                        ...
                                                        <div class="form-group col-lg-6"  >
                                                            ...
                                                            <div style="width:100%; text-align: center; background: #343a40; color: white; height: 35px; margin-top: 20px; border-radius: 8px 8px 0px 0px;  padding: 5px; "> Por Subsistema</div>
