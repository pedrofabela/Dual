                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Registrar Mentor de Unidad Económica </h3>
                                                                    </div>
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="col-md-12" style="margin-top: 15px;" >
                                                                                ...
                                                                                <div id="btnvalidar" style="display: none;">
                                                                                    ...
                                                                                    <div class="col-md-12"  >
                                                                                        <a href="Javascript:evento('consultaCurpMentorUE')" class="btn btn-success" >Consultar CURP</a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                     ...
                                                                                     <div class="form-group col-md-4">
                                                                                        ...
                                                                                        <s:if test="banGuardaResProg">
                                                                                         <div class="form-group col-md-4">
                                                                                         <a href="Javascript:evento2('guardaMentorUE')"  class="btn btn-round btn-primary">Guardar</a>
                                                                                         </div>
                                                                                        </s:if>
                                                                                         
                                                                                          <s:if test="banActualizaResProg">
                                                                                         <div class="form-group col-md-4">
                                                                                         <a href="Javascript:evento('actualizaMentorUE')" onclick="this.onclick = function () {return false}" class="btn btn-round btn-primary">Actualizar</a>
                                                                                         </div>
                                                                                        </s:if>
                                                                                         
                                                                                        <s:if test="banGeneraUser">
                                                                                            <div class="form-group col-md-4" >
                                                                                         <a href="Javascript:evento('generaUsuarioMentorUE')" onclick="this.onclick = function () {return false}" class="btn btn-round btn-primary" style="background: green;"    >Generar Usuario</a>
                                                                                         </div>  
                                                                    ...
                                                                    <div class="col-md-12" style="margin-top: 80px;">
                                                                        <div class="card">
                                                                            <div class="card-header card-header-primary card-header-icon">
                                                                                ...
                                                                                <h4 class="card-title">Mentores de Unidad Económica</h4>
                                                                            </div>
                                                                            <div class="card-body">
                                                                                <div class="toolbar">
                                                                                ...
                                                                                <div class="material-datatables">
                                                                                    ...
                                                                                    <div style="height: 500px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaResProgPEInst" id="ListaResProgPEInst" status="stat">                                                                                                                                      
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color: purple;  "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="ESTATUS==1"><a href="Javascript:actEstatus('actualizarEstatusUsuarioMUE','<s:property value="ID_USUARIO"/>','<s:property value="ESTATUS"/>')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="ESTATUS==0"><a href="Javascript:actEstatus('actualizarEstatusUsuarioMUE','<s:property value="ID_USUARIO"/>','<s:property value="ESTATUS"/>')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                        <td><a href="Javascript:actRes('consultaCurpMentorUE','<s:property value="CURP_PERSONA"/>')" style="text-decoration: none; "><i class="material-icons" style="color:blue;">create</i></a></td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="6"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Mentores de Unidad Económica!</div></td>
                                                                                            </tr>
