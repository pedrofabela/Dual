                                                                    ...
                                                                    <div class="col-md-12" >
                                                                        <div class="card">
                                                                            <div class="card-header card-header-primary card-header-icon">
                                                                                ...
                                                                                <h4 class="card-title">Unidades Economicas Difundidas</h4>
                                                                            </div>
                                                                            <div class="card-body">
                                                                                <div class="toolbar">
                                                                                         ...
                                                                                         <table id="datatables" class="table t table-striped  ">
                                                                                            <thead class="text-center" style="background: #302f2f; color:white;">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>SELECCIONAR UE POTENCIAL</th>
                                                                                                ...
                                                                                                <s:iterator value="ListaUEIE" id="ListaUEIE" status="stat">                                                                                                                                      
                                                                                                    <tr class="font-weight-bold text-center">
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <s:if test="STATUS_UE==1">
                                                                                                                <a href="Javascript:Activa('ActualizarEstatusUE','<s:property value="ID_IE_UE"/>','0')" style="text-decoration: none; "><i class="material-icons text-primary">check_box</i></a>
                                                                                                            </s:if>
                                                                                                            <s:if test="STATUS_UE==0">
                                                                                                                <a href="Javascript:Activa('ActualizarEstatusUE','<s:property value="ID_IE_UE"/>','1')" ><i class="material-icons text-primary">check_box_outline_blank</i></a>
                                                                                                            </s:if>
                                        ...
                                        <footer class="footer">
                                            <div class="container-fluid">
                                                ...
                                                <div class="copyright float-center">
                                                    ...
                                                    <s:textfield name="ue.STATUS_UE" id="status" cssStyle="display:none;"></s:textfield>
