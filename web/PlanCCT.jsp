                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Registrar Programa de Educativo </h3>
                                                                    </div>
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="row" style="margin-top: 20px;">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <s:textfield name="programa.CONSULTA_CVE_PLAN" id="cveplan" cssClass="form-control " ></s:textfield>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <a href="Javascript:enviar('consultaProgramas')" class="btn btn-rose pull-left">  Consultar</a>
                                                                            ...
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="material-datatables">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <s:iterator value="ListaProgramasEdu" id="ListaProgramasEdu" status="stat">
                                                                                                        ...
                                                                                                        <tr >
                                                                                                            ...
                                                                                                            <td class="text-right">
                                                                                                                <a href="Javascript:progcct('agregarProgramaCct','<s:property value="ID_PLAN"/>','<s:property value="escuela.ID_ESCUELA"/>')" class="btn btn-link btn-add btn-just-icon like"><i class="material-icons" style="color:green; font-size: 30px;">add_circle</i></a>
                                                                                                                ...
                                                                                                                <s:hidden name =  "ListaProgramasEdu[%{#stat.index}].ID_PLAN" id="ID_PLAN"></s:hidden>
                                                                                                                 <s:hidden name =  "ListaProgramasEdu[%{#stat.index}].FECHA_AUT_DUAL" id="FECHA_AUT_DUAL"></s:hidden>
                                                                                                    </s:iterator>
                                                                                    ...
                                                                                    <s:if test="bnprogno">
                                                                                        ...
                                                                                        <div style="width: 90%; height: 30px; padding: 5px; margin: auto; text-align: center; color: tomato;">¡No se encontro información, favor de buscar nuevamente!</div>
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">                                                                                                                                      
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="background: purple; text-decoration: none; color:white; "</s:if>>
                                                                                                        <td><s:property value="CVE_PLAN"/></td>
                                                                                                        <td><s:property value="NOM_CARRERA"/></td>
                                                                                                         <td><s:property value="CVE_PLAN_EST"/></td>
                                                                                                           <td><s:property value="VERSION"/></td>
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="7"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No hay programamas educativos registrados!</div></td>
                                                                                            </tr>
