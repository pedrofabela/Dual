...
<script type="text/javascript">
     ...
     function validarFormulario(){
        ...
        var cve_pro_edu=document.getElementById('CVE_PRO_EDU').value;
    ...
    if(matricula == null || matricula.length == 0 || /^\s+$/.test(matricula)){
      ...
      document.getElementById('MATRICULA').style.boxShadow="0px 1px 5px red";
      document.getElementById('MATRICULA').focus();
      return false;
    }else{
      document.getElementById('MATRICULA').style.boxShadow="";  
    }
    
     if(cve_pro_edu == null || cve_pro_edu.length == 0 || /^\s+$/.test(cve_pro_edu)){
      //alert('ERROR: El campo razon social no debe ir vacío.');
      document.getElementById('CVE_PRO_EDU').style.boxShadow="0px 1px 5px red";
      document.getElementById('CVE_PRO_EDU').focus();
      return false;
    }else{
      document.getElementById('CVE_PRO_EDU').style.boxShadow="";  
    }
    
    if(grado == null || grado.length == 0 || /^\s+$/.test(grado)){
      //alert('ERROR: El campo giro no debe ir vacío.');
      document.getElementById('GRADO').style.boxShadow="0px 1px 5px red";
      document.getElementById('GRADO').focus();
      return false;
    }else{
        document.getElementById('GRADO').style.boxShadow="";  
    }
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Registro de Alumnos Interesados </h3>
                                                                    </div>
                                                                    ...
                                                                    <div style="width: 90%; margin: auto; " >
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="col-md-12" style="margin-top: 15px;">
                                                                                ...
                                                                                <s:textfield name="al.CURPA" id="CONSULTA_CURP"  cssClass="form-control " oninput="validarInput(this)"></s:textfield>
                                                                            ...
                                                                            <div class="col-md-12" style="margin-top: 15px;" >
                                                                                ...
                                                                                <div id="btnvalidar" style="display: none;">
                                                                                    ...
                                                                                    <div class="col-md-12"  >
                                                                                        <a href="Javascript:evento('consultaCurpA')" class="btn btn-success" >Consultar CURP</a>
                                                                                    </div>
                                                                                ...
                                                                                <div style="width: 100%; text-align: center; color: #b11a4f; "> <s:fielderror fieldName="ErrorValCurp" id="ErrorValCurp" ></s:fielderror> </div>
                                                                                    
                                                                                <div class="col-lg-12 text-center text-danger font-weight-bold"> <s:fielderror fieldName="YaRegistrado" id="YaRegistrado" ></s:fielderror> </div>
                                                                                ...
                                                                                <s:if test="banMuestraForm">
                                                                                    <div class="row">                                                                                                                                                                     
                                                                                        ...
                                                                                        <s:textfield  cssClass="form-control " name="al.CURP" id="CURP" readonly="true"/>
                                                                                        ...
                                                                                        <s:textfield  cssClass="form-control " name="al.NOMBRE" id="NOMBRE" readonly="true"/>
                                                                                        <s:fielderror fieldName="NOMA" id="NOMA" cssClass="alert alert-danger"></s:fielderror>

                                                                                        </div>
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="examplePass" class="bmd-label-floating">Apellido Paterno</label>
                                                                                        <s:textfield cssClass="form-control" name="al.APELLIDOP" id="APELLIDOP" readonly="true"/>
                                                                                        ...
                                                                                        <s:textfield cssClass="form-control" name="al.APELLIDOM" id="lAPELLIDOP" readonly="true"/>
                                                                                        ...
                                                                                        <s:textfield cssClass="form-control" name="al.FEC_NAC" id="al.FEC_NAC" readonly="true"/>
                                                                                        ...
                                                                                        <s:textfield cssClass="form-control" name="al.ENTIDAD_NAC" id="al.ENTIDAD_NAC" readonly="true"/>
                                                                                        ...
                                                                                        <s:textfield cssClass="form-control" name="al.SEXO" id="al.SEXO" readonly="true"/>
                                                                                        <s:fielderror fieldName="GENERO" cssClass="alert alert-danger"></s:fielderror>
                                                                                         </div>     
                                                                                           <div class="form-group col-md-4">
                                                                                            <label for="examplePass" class="bmd-label-floating">MATRICULA</label>
                                                                                        <s:textfield cssClass="form-control" name="al.MATRICULA" id="MATRICULA" />
                                                                                        <s:fielderror fieldName="GENERO" cssClass="alert alert-danger"></s:fielderror>
                                                                                         </div>
                                                                                         
                                                                                           <div class="form-group col-md-4">
                                                                                            <label for="examplePass" class="bmd-label-floating">PROGRAMA EDUCATIVO</label>
                                                                                       <s:select  data-style="select-with-transition"   name="al.CVE_PRO_EDU" id="CVE_PRO_EDU" list="ListaProgramas"  listKey="ID_CCT_PLAN"  listValue="CARRERA" headerKey="" headerValue="--SELECCIONE--"  cssClass="selectpicker col-lg-12"  />
                                                                                       <s:iterator value="ListaProgramas" id="ListaProgramas" status="stat">
                                                                                           <s:hidden  name = "ListaInteresados[%{#stat.index}].ID_CCT_PLAN" id="ID_CCT_PLAN"></s:hidden>
                                                                                           <s:hidden  name = "ListaInteresados[%{#stat.index}].CARRERA" id="CARRERA"></s:hidden>
                                                                                       </s:iterator>
                                                                                        <s:fielderror fieldName="GENERO" cssClass="alert alert-danger"></s:fielderror>
                                                                                         </div>
                                                                                         
                                                                                          <div class="form-group col-md-4">
                                                                                            <label for="examplePass" class="bmd-label-floating">PERIODO</label>
                                                                                        <s:select  data-style="select-with-transition"   name="al.GRADO" id="GRADO" list="ListaGrados"  listKey="ID_CATALOGO"  listValue="DESCRIPCION" headerKey="" headerValue="--SELECCIONE--"  cssClass="selectpicker col-lg-12"  />
                                                                                        <s:iterator value="ListaGrados" id="ListaGrados" status="stat">
                                                                                           <s:hidden  name = "ListaGrados[%{#stat.index}].ID_CATALOGO" id="ID_CATALOGO"></s:hidden>
                                                                                           <s:hidden  name = "ListaGrados[%{#stat.index}].DESCRIPCION" id="DESCRIPCION"></s:hidden>
                                                                                       </s:iterator>
                                                                                        <s:fielderror fieldName="GENERO" cssClass="alert alert-danger"></s:fielderror>
                                                                                         </div>                                                                                                                                                                          
                                                                                         
                                                                                        <s:if test="banGuardaInteresado">
                                                                                         <div class="form-group col-md-12 text-center">
                                                                                         <a href="Javascript:evento2('GuardaInteresado')"  class="btn btn-round btn-primary">Registrar Interesado</a>
                                                                                         </div>
                                                                                        </s:if>
                                                                                         
                                                                                        <s:if test="banActualizaInteresado">
                                                                                         <div class="form-group col-md-12 text-center">
                                                                                         <a href="Javascript:evento2('ActualizaInteresado')"  class="btn btn-round btn-primary">Actualizar y Registrar Alumno Interesado</a>
                                                                                         </div>
                                                                                        </s:if> 
                                                                  ...
                                                                  <!--LISTA DE INTERESADOS -->                  
                                                                    ...
                                                                    <div class="col-md-12" style="margin-top: 80px;">
                                                                        <div class="card">
                                                                            <div class="card-header card-header-primary card-header-icon">
                                                                                ...
                                                                                <h4 class="card-title">Aspirantes Interesados</h4>
                                                                            </div>
                                                                            <s:if test="ListaInteresados.size()>0">
                                                                            <div class="card-body">
                                                                                <div class="toolbar">
                                                                                ...
                                                                                <div class="material-datatables">
                                                                                    ...
                                                                                    <div style="height: 500px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaInteresados" id="ListaInteresados" status="stat">                                                                                                                                      
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <s:if test="STATUS_PROCESO==1">
                                                                                                        <td><a href="Javascript:Eliminar('EliminaInteresado','<s:property value="ID_HISTORICO"/>')" ><i class="material-icons text-danger">delete</i></a></td>
                                                                                                        </s:if>
                                                                                                       
                                                                                                    </tr>
                                                                                                        
                                                                                                    <s:hidden  name = "ListaInteresados[%{#stat.index}].ID_ALUMNO" id="ID_ALUMNO"></s:hidden>
                                                                                                    <s:hidden  name = "ListaInteresados[%{#stat.index}].CURP" id="CURP"></s:hidden>
                                                                                                    <s:hidden  name = "ListaInteresados[%{#stat.index}].NOMBRE_COMPLETO" id="NOMBRE_COMPLETO"></s:hidden>
                                                                                                    <s:hidden  name = "ListaInteresados[%{#stat.index}].MATRICULA" id="MATRICULA"></s:hidden>
                                                                                                    <s:hidden name =  "ListaInteresados[%{#stat.index}].NOM_PRO_EDU" id="NOM_PRO_EDU"></s:hidden>
                                                                                                    <s:hidden name =  "ListaInteresados[%{#stat.index}].GRADO" id="GRADO"></s:hidden>
                                                                                                    <s:hidden name =  "ListaInteresados[%{#stat.index}].STATUS_PROCESO" id="STATUS_PROCESO"></s:hidden>
                                                                    ...
                                                                    <s:else>
                                                                        <div class="col-lg-12 text-center text-danger font-weight-bold" >**NO HAY REGISTRO DE ALUMNOS INTERESADOS**</div>
                                                                    </s:else>
                                                                </div>
