...
<script type="text/javascript">
   ...
   document.formularioPrincipal.action = accion;
    ...
    function selectPersona(accion, persona, estatus) {
        
        document.formularioPrincipal.AUXPERSONA.value = persona;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Vincular Mentor Unidad Económica con Programa de Educativo </h3>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12" style="margin-top: 80px;">
                                                                        <div class="card">
                                                                            <div class="card-header card-header-primary card-header-icon">
                                                                                ...
                                                                                <h4 class="card-title">Mentores de Unidad Económicas</h4>
                                                                            </div>
                                                                            <div class="card-body">
                                                                                <div class="toolbar">
                                                                                ...
                                                                                <s:if test="objRenapo.AUXPERSONA.length()==0">
                                                                                    ...
                                                                                    <div style="height: 400px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaResProgPEInst" id="ListaResProgPEInst" status="stat">                                                                                                                                      
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color: purple;  "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="objRenapo.AUXPERSONA.length()<0"><a href="Javascript:selectPersona('SelectVinMentorUE','<s:property value="ID_PERSONA"/>','1')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="objRenapo.AUXPERSONA.length()==0"><a href="Javascript:selectPersona('SelectVinMentorUE','<s:property value="ID_PERSONA"/>','0')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                    </tr>
                                                                                           ...
                                                                                           <s:if test="ListaResProgPEInst.size()==0">
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="3"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Mentores de Unidad Económica!</div></td>
                                                                                            </tr>
                                                                                ...
                                                                                <s:else>
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaResProgPEInst" id="ListaResProgPEInst" status="stat">                                                                                                                                      
                                                                                                    ...
                                                                                                    <s:if test="objRenapo.AUXPERSONA==ID_PERSONA">
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color: purple;  "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="objRenapo.AUXPERSONA.length()>0"><a href="Javascript:selectPersona('SelectVinMentorAcad','<s:property value="ID_PERSONA"/>','1')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="objRenapo.AUXPERSONA.length()==0"><a href="Javascript:selectPersona('SelectVinMentorAcad','<s:property value="ID_PERSONA"/>','0')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                    </tr>
                                                                                 ...
                                                                                 <div style="height: 200px; overflow-y: scroll;">
                                                                                     ...
                                                                                     <s:if test="ListaProgramasEscuela.size()>0">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">                                                                                                                                      
                                                                                                    ...
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="PROGVINCULADO==1"><a href="Javascript:actResProg('actualizaMentorUEResProgInst','<s:property value="ID_RES_PROGEDU"/>','0')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="PROGVINCULADO==null"><a href="Javascript:regResProg('guardaMentorResMentoUEProgInst','<s:property value="ID_PLAN"/>')" ><i class="material-icons">check_box_outline_blank</i></a></s:if><s:if test="PROGVINCULADO==0"><a href="Javascript:actResProg('actualizaMentorUEResProgInst','<s:property value="ID_RES_PROGEDU"/>','1')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                    </tr>
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="3"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Programas Educativos!</div></td>
                                                                                            </tr>
                                                                                     ...
                                                                                     <s:else>
                                                                                         ...
                                                                                         <s:if test="objRenapo.AUXPERSONA.length()>0">
                                                                                         <div style="width: 100%; color: red; margin: auto; text-align: center;">¡No hay programas vinculados al Responsable de Programa Educatvo!</div>
                                                                                         </s:if>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <s:textfield name="objRenapo.ID_PERSONA" id="IDPERSONA" cssStyle="display:none;"  ></s:textfield>  
                                                 <s:textfield name="objRenapo.AUXPERFIL" id="AUXPERFIL" cssStyle="display:none;"  ></s:textfield>  
                                                   <s:textfield name="objRenapo.AUXPERSONA" id="AUXPERSONA" cssStyle="display:none;" ></s:textfield>  
