                                                                                ...
                                                                                <div class="material-datatables">
                                                                                    ...
                                                                                    <div style="height: 500px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaUsuarios" id="ListaUsuarios" status="stat">                                                                                                                                      
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td><s:property value="TELCASA_PERSONA"/></td>
                                                                                                          <td><s:property value="TELCEL_PERSONA"/></td>
                                                                                                        <td><s:property value="CORREO_PERSONA"/></td>
                                                                                                    </tr>
                                                                                                        
                                                                                                    <s:hidden  name = "ListaUsuarios[%{#stat.index}].NOMBRE_COMPLETO" id="NOMBRE_COMPLETO"></s:hidden>
                                                                                                    <s:hidden  name = "ListaUsuarios[%{#stat.index}].NAMEPERFIL" id="NAMEPERFIL"></s:hidden>
                                                                                                    <s:hidden  name = "ListaUsuarios[%{#stat.index}].USUARIO_LOGIN" id="USUARIO_LOGIN"></s:hidden>
                                                                                                    <s:hidden  name = "ListaUsuarios[%{#stat.index}].PASSWORD" id="PASSWORD"></s:hidden>
                                                                                                    <s:hidden name =  "ListaUsuarios[%{#stat.index}].TELCASA_PERSONA" id="TELCASA_PERSONA"></s:hidden>
                                                                                                    <s:hidden name =  "ListaUsuarios[%{#stat.index}].TELCEL_PERSONA" id="TELCEL_PERSONA"></s:hidden>
                                                                                                     <s:hidden name =  "ListaUsuarios[%{#stat.index}].CORREO_PERSONA" id="CORREO_PERSONA"></s:hidden>
                                                                                                </s:iterator>  
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="7"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Usuarios Registrados!</div></td>
                                                                                            </tr>
