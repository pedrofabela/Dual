                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Vincular Responsable de UE a Programa Educativo</h3>
                                                                    </div>
                                                                    ...
                                                                    <div style="width: 90%; margin: auto; " >
                                                                        ...
                                                                        <div class="card-body">
                                                                         ...
                                                                         <s:select  data-style="select-with-transition"   name="ue.ID_IE_UE" id="IDIEUE" list="ListaUEIE"  listKey="ID_IE_UE"  listValue="RAZON_SOCIAL" headerKey="" headerValue="Selecciones Unidad Económica" onchange="Javascript:consulta('consultaResUEIEVin')" cssClass="selectpicker col-lg-12"  />
                                                                                ...
                                                                                <div class="material-datatables">
                                                                                    ...
                                                                                    <div style="height: 300px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaResProgPEInst" id="ListaResProgPEInst" status="stat">                                                                                                                                      
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color: purple;  "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="objRenapo.ID_PERSONA==ID_PERSONA"><a href="Javascript:actEstatus('conRUE','<s:property value="ID_PERSONA"/>')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="objRenapo.ID_PERSONA!=ID_PERSONA"><a href="Javascript:actEstatus('conRUE','<s:property value="ID_PERSONA"/>')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                        </tr>
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="3"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron responsables de Unidad Económica!</div></td>
                                                                                            </tr>
                                                                                ...
                                                                                <s:if test="objRenapo.ID_PERSONA.length()>0">
                                                                                    ...
                                                                                    <div style="height: 100px; overflow-y: scroll;">
                                                                                        ...
                                                                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                                                            ...
                                                                                            <tr >
                                                                                                <td colspan="3"><div style="width: 100%; height: 30px; text-align: center; color: #b11a4f">¡No se encontraron Programas Educativos registrados!</div></td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <s:iterator value="ListaProgramasEscuela" id="ListaProgramasEscuela" status="stat">                                                                                                                                      
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color:purple; "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="PROGVINCULADO==1"><a href="Javascript:actResProg('actualizaResUEProgInst','<s:property value="ID_RES_PROGEDU"/>','0')" style="text-decoration: none; "><i class="material-icons">check_box</i></a></s:if><s:if test="PROGVINCULADO==null"><a href="Javascript:regResProg('guardaResUEProgInst','<s:property value="ID_PLAN"/>')" ><i class="material-icons">check_box_outline_blank</i></a></s:if><s:if test="PROGVINCULADO==0"><a href="Javascript:actResProg('actualizaResUEProgInst','<s:property value="ID_RES_PROGEDU"/>','1')" ><i class="material-icons">check_box_outline_blank</i></a></s:if></td>
                                                                                                    </tr>
