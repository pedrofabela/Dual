                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 20px;">
                                                                    ...
                                                                    <div style="width: 90%; margin: auto;  color:#302f2f; text-align: center; margin-top: 20px;" >
                                                                        ...
                                                                        <h3> Registro de Responsable de Programa Educativo </h3>
                                                                    </div>
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="col-md-12" style="margin-top: 15px;" >
                                                                                ...
                                                                                <div id="btnvalidar" style="display: none;">
                                                                                    ...
                                                                                    <div class="col-md-12"  >
                                                                                        <a href="Javascript:evento('consultaCurp')" class="btn btn-success" >Consultar CURP</a>
                                                                                    </div>
                                                                                ...
                                                                                <s:if test="objRenapo.NOMBRE_RENAPO!=''">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <s:if test="banGuardaResProg">
                                                                                         <div class="form-group col-md-4">
                                                                                         <a href="Javascript:evento2('guardaResPe')"  class="btn btn-round btn-primary">Guardar</a>
                                                                                         </div>
                                                                                        </s:if>
                                                                                         
                                                                                          <s:if test="banActualizaResProg">
                                                                                         <div class="form-group col-md-4">
                                                                                         <a href="Javascript:evento('actualizaResPe')" onclick="this.onclick = function () {return false}" class="btn btn-round btn-primary">Actualizar</a>
                                                                                         </div>
                                                                                        </s:if>
                                                                                           <s:if test="banGeneraUser">
                                                                                            <div class="form-group col-md-4" >
                                                                                         <a href="Javascript:evento('generaUsuarioResProgEdu')" onclick="this.onclick = function () {return false}" class="btn btn-round btn-primary" style="background: green;"    >Generar Usuario</a>
                                                                                         </div>  
                                                                                                ...
                                                                                                <s:iterator value="ListaResProgPEInst" id="ListaResProgPEInst" status="stat">                                                                                                                                      
                                                                                                    <tr <s:if test="ID_PLAN==escuela.AUXPLAN">style="color: purple;  "</s:if>>
                                                                                                        ...
                                                                                                        <td><s:if test="ESTATUS==1">
                                                                                                            ...
                                                                                                            <s:if test="ESTATUS==0">
                                                                                                                <a href="Javascript:actEstatus('actualizarEstatusUsuario','<s:property value="ID_USUARIO"/>','<s:property value="ESTATUS"/>')" ><i class="material-icons">check_box_outline_blank</i>
                                                                                                                </a>
                                                                                                            </s:if>
                                                                                                        </td>
