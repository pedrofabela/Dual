 ...
 * @author pedro
 */
public class ResMentorAcad_Action extends ActionSupport implements SessionAware{
 ...
 consultaRenapo renapo=new consultaRenapo();
  ...
  Catalogos_Action catalogos= new Catalogos_Action();
    ...
    public Map getSession() {
        ...
        try {
           ...
           boolean valEmail = checkEmail(objRenapo.getCORREO_PERSONA());
            ...
            while (LRPE.hasNext()) {
                ...
                objRenapo.setPERFIL("27");
            
                  con.guardaResPeIe(objRenapo);
                  
                  
                  
                  objRenapo.setUSUARIO(objRenapo.getCURP().substring(1,4)+"-MTOR"+objRenapo.getAUXESCUELA());
                  ...
                  usuariocons.setNAMEPERFIL_VARIABLE("Mentor Académico");
     ...
     public String generaUsuarioMentor() {
