 ...
 * @author pedro
 */
public class ResProgEducativo_Action extends ActionSupport implements SessionAware {
        ...
        try {
            ...
            if (valEmail && telCasa && telCel) {
                ...
                if (valEmail) {
                    ...
                    objRenapo.setPERFIL("25");

                    con.guardaResPeIe(objRenapo);

                    objRenapo.setUSUARIO(objRenapo.getCURP().substring(1, 4) + "-RPE" + objRenapo.getAUXESCUELA());

                    objRenapo.setPASSWORD(conspassword());

                    usuariocons.setESTATUS_VARIABLE("1");
                    usuariocons.setNAMEPERFIL_VARIABLE("Responsable de Programa Educativo");
    ...
    public String actualizarEstatusUsuario() {
    ...
    public String guardaResProgInst() {
    ...
    public String actualizaResProgInst() {
    ...
    public String generaUsuarioResProgEdu() {
